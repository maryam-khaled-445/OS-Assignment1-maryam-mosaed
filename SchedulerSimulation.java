...
public class SchedulerSimulation {
    ...
    public static void main(String[] args) {
        ...
        while (!processQueue.isEmpty()) {
            ...
            Process p = processMap.get(thread);  // احصل على العملية المرتبطة بالـ Thread
    ...
    // Method to add a process to the queue and map, while printing a "ready" message
     public static void addProcessToQueue(Process process,
        ...
        System.out.println(Colors.BLUE + "➕ " + process.getName() +
                " (Priority: " + Colors.BRIGHT_YELLOW + process.getPriority() + Colors.BLUE + ")" +
